...
import { business } from '../../store/actions/healthAction'
...
const badgeStyle={
 ...
 class Business extends Component {
    ...
    render() {
        ...
        const bussinessnewsPost=post? post.map((el)=>{
            return(
                <div className='col l3 m4 s6' >
                   ...
                   <div className="card"  >
                      <div className="card-image">
                              ...
                              <span className=' badge' style={ badgeStyle } >business</span>
...
const mapdataToprops=(state)=>{
    console.log(state)
    return{
       post:state.business.businessPost 
    }
}
...
export default connect(mapdataToprops,mapdispatchToprops)(Business)
