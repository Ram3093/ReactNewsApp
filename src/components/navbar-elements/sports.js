...
import { sports } from '../../store/actions/healthAction'
...
export class Sports extends Component {
    render() {
        ...
        const sportnewsPost=post? post.map((el)=>{
            return(
...
<div className="card"  >
                      <div className="card-image">
                              ...
                              <span className=' badge' style={ badgeStyle } >sport</span>
...
const mapdispatchToprops=(dispatch)=>{
    return{
         ...
         business:  dispatch(sports()) 

    }
}

export default connect(mapdataToprops,mapdispatchToprops)(Sports)
