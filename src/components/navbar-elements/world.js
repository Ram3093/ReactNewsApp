...
import { world } from '../../store/actions/healthAction'
...
const badgeStyle={
 ...
 class World extends Component {
    ...
    render() {
        ...
        const worldnewsPost=post? post.map((el)=>{
            return(
...
<div className="card"  >
                      <div className="card-image">
                              ...
                              <span className=' badge' style={ badgeStyle } >world</span>
...
const mapdispatchToprops=(dispatch)=>{
    return{
         ...
         business:  dispatch(world()) 

    }
}

export default connect(mapdataToprops,mapdispatchToprops)(World)
